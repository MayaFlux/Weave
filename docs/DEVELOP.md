...
./macos/scripts/create_pkg.sh 0.2.1
# Output: build/macos/Weave-0.2.1.pkg
```
...
.\windows\scripts\create_installer.ps1 -Version 0.2.1
# Output: build\windows\Weave-0.2.1.exe
```
